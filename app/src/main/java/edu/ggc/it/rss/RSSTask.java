...
public class RSSTask extends AsyncTask<RSSFeed, Void, Void> {
     ...
     * Constructor
     *
     * @param task       a reference to a class that implements RSSTaskComplete
     * @param context    Context of activity using this class
     * @param showDialog if true ProgressDialog will be shown
     */
     ...
     *
     * @param feeds an array of RSSFeed's passed when RSSTask.execute(RSSFeed) is called
     */
    @Override
